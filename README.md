...
| **普法讲座** | 法律条文转化为通俗易懂的科普讲座 | 劳动法、民法典、消费维权 |
...
| 功能 | 描述 |
|------|------|
| **PPT 生成** | 一键生成精美演示课件（Slidev 驱动） |
| **语音合成** | 真人级语音，多种音色可选，支持声音克隆 |
